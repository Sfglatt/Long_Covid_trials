...
setdiff(colnames(c1_baseline), colnames(c2_baseline))
...
table(merged_data[merged_data$Attrition == 1,]$gender_identity_0.m)
...
table(merged_data[merged_data$Attrition == 1,]$ethnicity_0.m, 
      merged_data[merged_data$Attrition == 1,]$birth_sex_0.m)
...
merged_data <- merged_data %>% mutate_at(vars(ends_with(".m"), -starts_with("c19"), -starts_with("C19")), as.numeric)
...
I_A_F_items <- c(
  "AIM_1_0.m", "AIM_2_0.m", "AIM_3_0.m", "AIM_4_0.m",
  "IAM_1_0.m", "IAM_2_0.m", "IAM_3_0.m", "IAM_4_0.m",
  "FIM_1_0.m", "FIM_2_0.m", "FIM_3_0.m", "FIM_4_0.m",
...
merged_data$AIM_mod_1_AVERAGE_0 <- rowMeans(merged_data[, c("AIM_1_0.m", "AIM_2_0.m", "AIM_3_0.m", "AIM_4_0.m")], 
                                            na.rm = FALSE)
merged_data$IAM_mod_1_AVERAGE_0 <- rowMeans(merged_data[, c("IAM_1_0.m", "IAM_2_0.m", "IAM_3_0.m", "IAM_4_0.m")], 
                                            na.rm = FALSE)
merged_data$FIM_mod_1_AVERAGE_0 <- rowMeans(merged_data[, c("FIM_1_0.m", "FIM_2_0.m", "FIM_3_0.m", "FIM_4_0.m")], 
                                            na.rm = FALSE)
...
merged_data_imputed <- merged_data_imputed %>% rename(
  QOL_Q11_0_imputed.m = QOL_Q11_0.m, 
...
write.csv(merged_data, "Created_datasets/Cohorts_1_2_3_data_3.10.25.csv", row.names = TRUE)
```
