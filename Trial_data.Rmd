...
# Save dataset
# write.csv(merged_data, "Created_datasets/Cohorts_1_2_3_data_6.7.csv")
# colnames(merged_data)
```
...
merged_data <- merged_data %>%
  mutate(# Domain 1
         WHO_D1_SUM_0 = rowSums(select(., c("WHODAS_d1_1_0.m", "WHODAS_d1_2_0.m", "WHODAS_d1_3_0.m", 
                                            "WHODAS_d1_4_0.m", "WHODAS_d4_5_0_imputed.m", "WHODAS_d1_6_0.m")), 
                                na.rm = FALSE),
...
write.csv(merged_data, "Created_datasets/Cohorts_1_2_3_data_latest.csv", row.names = TRUE)
```
...
```{r Paired comparison, eval = FALSE}
#### QOL ####
# use imputed dataset
