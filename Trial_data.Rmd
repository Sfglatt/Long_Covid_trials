...
write.csv(merged_data, "Cohorts_1_2_3_all_data_6.5.csv")
```

```{r Import new data, eval = FALSE}
...
table(subset_data$birth_sex_0.m)
table(subset_data$race_0.m)
summary(subset_data$age_0.m)
sd(subset_data$age_0.m)
...
jmv::ttestPS(
    data = merged_data[merged_data$Cohort ==3,],
    pairs = list(
        list(
            i1="QPR_SUM_0",
            i2="QPR_SUM_2")),
...
Tank_long <- readxl::read_xlsx("Oil_Tank_Tracking_per_Session_Long.xlsx")
