...
# If you don't have the above data imported, uncomment and run the below:
# merged_data <- read.csv("Created_datasets/Created_datasets/Cohorts_1_2_3_data_latest.csv")
# head(merged_data)
...
merged_data <- read.csv("Created_datasets/Cohorts_1_2_3_data_6.9.csv")
...
jmv::ttestPS(
    ...
    pairs = list(
        list(
            i1="C19_severity_SUM_0",
            i2="C19_severity_SUM_2")),
    wilcoxon = TRUE,
    norm = TRUE,
    qq = TRUE,
    meanDiff = TRUE,
...
jmv::ttestPS(
    ...
    pairs = list(
        list(
            i1="c19yrs_health_now_0.m",
            i2="c19yrs_health_now_2.m")),
    wilcoxon = TRUE,
    norm = TRUE,
    qq = TRUE,
    meanDiff = TRUE,
