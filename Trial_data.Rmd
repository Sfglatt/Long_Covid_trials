...
merged_quant_oil_attend_data <- merged_quant_oil_attend_data %>%
...
# Save dataset
write.csv(merged_quant_oil_attend_data, "Created_datasets/Cohorts_1_2_3_data_6.6.csv")
```
...
# If you don't have the above data imported, uncomment and run the below:
merged_data <- read.csv("Created_datasets/Cohorts_1_2_3_data_6.6.csv")
head(merged_data)
...
jmv::ttestPS(
    ...
    pairs = list(
        list(
            i1="FSCQ_Viv_AVERAGE_0",
            i2="FSCQ_Viv_AVERAGE_2")),
    wilcoxon = TRUE,
    norm = TRUE,
    qq = TRUE,
    meanDiff = TRUE,
