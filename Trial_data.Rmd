...
```{r Weekly attendance, eval = FALSE}
# If you don't have the above data imported, uncomment and run the below:
...
merged_quant_oil_attend_data <- merge(
  merged_quant_oil_data,
  Attendance,
  by = "ID",
  all = TRUE)

# Save dataset
# write.csv(merged_quant_oil_attend_data, "Created_datasets/Cohorts_1_2_3_data_6.7.csv")
```
